...
# 1. 读取 CSV
# ======================
csv_path = "./gspo_training_log_20260430_135443.csv"   # 改成你的路径
...
plt.plot(df["global_step"], smooth(df["mean_vina"], SMOOTH_WINDOW), label="mean_vina")
plt.plot(df["global_step"], smooth(df["mean_qed"], SMOOTH_WINDOW), label="mean_qed")
plt.plot(df["global_step"], smooth(df["mean_sa"], SMOOTH_WINDOW), label="mean_sa")

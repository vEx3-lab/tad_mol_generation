...
if __name__ == '__main__':
    ...
    # from model.decoder_only_tfm_v3 import decoder_only_lm
    from model.v7 import decoder_only_lm  # 新版模型
    ...
    # 保存目录
    save_dir = config["paths"]["save_dir"].format(model_name=model_name+ 'v4')

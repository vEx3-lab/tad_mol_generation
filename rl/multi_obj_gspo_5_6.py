...
def train_gspo_5_6(
    ...
    for it in range(1, iterations + 1):
        ...
        for step in range(1, M + 1):
            ...
            valid = []
            for token_ids, reward, smiles, old_lp, item in zip(
                batch_token_ids,
                rewards,
                batch_smiles,
                batch_old_logprobs,
                ...
                if reward != 0 and old_lp is not None:
                    valid.append((token_ids, float(reward), smiles, old_lp, item))
            ...
            valid_items = [x[4] for x in valid]
            ...
            elite_added = 0
            for token_ids, reward, smiles, old_lp, item in valid:
...
if __name__ == "__main__":
    ...
    train_gspo_5_6(
        ...
        temperature=1.05,
        top_k=50,
        reward_weights={"vina": 1.0, "qed": 0.2, "sa": 0.15, "logp": 0.0},
        log_dir=os.path.join(BASE_DIR, "rl/feedback/logs"),
        save_dir=os.path.join(BASE_DIR, "rl/feedback/best_models"),
        elite_buffer_size=300,
        aux_batch_size=8,

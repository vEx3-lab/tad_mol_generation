...
"""
GSPO 5_6 20260508 variant.

This version keeps the original GSPO mean-ratio policy objective, and applies
three stability changes based on the latest training logs:
...
def train_gspo_5_6(
    ...
    columns = [
        ...
        "policy_loss", "kl_loss", "gspo_loss", "aux_loss", "total_loss", "ratio_mean",
        ...
        "elite_size", "elite_added", "aux_batch_size", "aux_coef",

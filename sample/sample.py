...
def generate_selfies(model,vocab,device="cuda", max_len=80, temperature=1.0, top_k=None):
    """
    ...
    return {
        ...
        "ended_with_eos": generated_tokens[-1] == "<EOS>",
    }
...
if __name__ == '__main__':
    ...
    # model_path = '../rl/feedback/best_models/best_total_loss_20260323_173854.pt'
    model_path = '../rl/feedback/best_models/best_reward_20260323_173854.pt'
    # model_path = '../train/model/decoder_only_tfm/best_model_fold1.pt'
